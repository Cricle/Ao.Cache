...
namespace Ao.Cache.CodeGen
{
    internal static class TypeConsts
    {
        ...
        public const string DefaultNameSpace = "Ao.Cache.Gen";

        public const string IDataAccesstorNameSpaceName = "NameSpace";

        public const string TaskTypeName = "System.Threading.Tasks.Task";

        public const string ValueTaskTypeName = "System.Threading.Tasks.ValueTask";

        public const string ProxyDefaultEndName = "Proxy";
